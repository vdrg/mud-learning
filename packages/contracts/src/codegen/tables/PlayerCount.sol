...
library PlayerCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "main", name: "PlayerCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d61696e00000000000000000000506c61796572436f756e740000000000);
